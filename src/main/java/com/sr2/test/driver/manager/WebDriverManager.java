...
public class WebDriverManager {
	...
	public static RemoteWebDriver getDriverDynamic() throws MalformedURLException {
		...
		if (defaultBrowser.equals("firefox") || defaultBrowser.equals("ff")) {
			...
			String driverPath = new File("").getAbsolutePath() + File.separatorChar + "src"+ File.separatorChar + "test" + File.separatorChar +"resources" + File.separatorChar + "geckodriver.exe";
